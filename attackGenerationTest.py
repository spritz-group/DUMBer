...
attacksParams = {
    "math": {
        "BIM": {"init": 0.05, "steps": 0.05, "threshold": 0.3},
        "DeepFool": {"init": 10, "steps": 10, "threshold": 100},
        "FGSM": {"init": 0.05, "steps": 0.05, "threshold": 0.3},
        "PGD": {"init": 0.05, "steps": 0.05, "threshold": 0.3},
        "RFGSM": {"init": 0.05, "steps": 0.05, "threshold": 0.3},
        "Square": {"init": 0.1, "steps": 0.1, "threshold": 0.3},
        "TIFGSM": {"init": 0.05, "steps": 0.05, "threshold": 0.3}
    },
    "nonmath": {
        "BoxBlur": {"init": 1, "steps": 1, "threshold": 10},
        "GaussianNoise": {"init": 0.01, "steps": 0.01, "threshold": 0.1},
        "GreyScale": {"init": 1, "steps": 0, "threshold": 1},
        "InvertColor": {"init": 1, "steps": 0, "threshold": 1},
        "RandomBlackBox": {"init": 20, "steps": 20, "threshold": 200},
        "SaltPepper": {"init": 0.01, "steps": 0.01, "threshold": 0.1},
